...
Propuesta de sistema de diseño para los mails, pendiente de aplicar por la migración a MJML:
[`design/email-design-system.md`](design/email-design-system.md) + [`design/tokens.json`](design/tokens.json).
